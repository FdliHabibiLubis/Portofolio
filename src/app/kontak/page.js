              ...
              <div className="space-y-3">
                {[
                  ...
                  <a key={item.label}
                    ...
                    onMouseEnter={(e) => { e.currentTarget.style.background = C.primaryBg; e.currentTarget.style.borderColor = C.primaryBorder; }}
                ...
                <form id="contact-form" onSubmit={handleContactSubmit} className="space-y-5">
                  ...
                  {[
                    ...
                    <div key={f.id} className="space-y-1.5">
                      <label htmlFor={f.id} className="block font-bold text-[11px] uppercase tracking-wider"
                        style={{ color: C.muted }}>{f.label}</label>
                  ...
                  <div className="space-y-1.5">
                    <label htmlFor="input-message" className="block font-bold text-[11px] uppercase tracking-wider"
                      style={{ color: C.muted }}>Pesan</label>
                  ...
                  <motion.button id="submit-form" whileHover={{ scale: 1.01 }} whileTap={{ scale: 0.99 }}
                    type="submit" disabled={isSubmitting}
                    className="w-full py-3.5 rounded-xl font-black text-sm transition-all duration-200 disabled:opacity-60"
                    style={{ background: C.primary, color: "#fff" }}
                    onMouseEnter={(e) => { if (!isSubmitting) e.currentTarget.style.background = C.primaryDark; }}
